...
exports._ViafusionDBFromFile = void 0;
var viafusiondb_1 = require("./viafusiondb");
var _ViafusionDBFromFile = (function (_super) {
    __extends(_ViafusionDBFromFile, _super);
    function _ViafusionDBFromFile(opts) {
        return _super.call(this, opts) || this;
    }
    _ViafusionDBFromFile.prototype.prepare_init_file_db = function (dbname, tablename) {
    ...
    _ViafusionDBFromFile.prototype.start_copy_from_file = function (filepath, database, tabelname) {
    ...
    _ViafusionDBFromFile.prototype.create_file_table = function (client, tablename) {
        if (tablename === void 0) { tablename = "users"; }
        return __awaiter(this, void 0, void 0, function () {
            var query;
            return __generator(this, function (_a) {
    ...
    _ViafusionDBFromFile.prototype._copy_from_file = function (client, filepath, tabelname) {
        if (tabelname === void 0) { tabelname = "users"; }
    ...
    return _ViafusionDBFromFile;
}(viafusiondb_1._ViafusionDB));
exports._ViafusionDBFromFile = _ViafusionDBFromFile;
