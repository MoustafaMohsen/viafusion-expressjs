...
exports.TranService = void 0;
var security_1 = require("./security");
var helper_1 = require("../util/helper");
var viafusiondb_1 = require("../db/viafusiondb");
var TranService = (function () {
    function TranService() {
    }
    TranService.prototype.create_db_user = function (user) {
    ...
    TranService.prototype.get_db_user = function (minimum_user_object) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    TranService.prototype.update_db_user = function (user, newuser) {
        return __awaiter(this, void 0, void 0, function () {
            var db, results, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    TranService.prototype.login_or_register_to_otp = function (_login) {
        return __awaiter(this, void 0, void 0, function () {
            var user, otp;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    TranService.prototype.set_user_otp = function (minimum_user_object, otp) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    TranService.prototype.confirm_user_otp = function (minimum_user_object, otp) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    TranService.prototype.update_security_otp = function (user, otp) {
        var security = this.get_user_security(user);
        security.login._otp_value = otp + "";
        return security;
    };
    TranService.prototype.set_user_pin = function (minimum_user_object, pin) {
        return __awaiter(this, void 0, void 0, function () {
            var db, user, security, newuser, updatedUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    TranService.prototype.confirm_user_pin = function (minimum_user_object, pin) {
        return __awaiter(this, void 0, void 0, function () {
            var db, user, updatedUser, updatedUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    TranService.prototype.refresh_security = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    TranService.prototype.update_security_pin = function (user, pin) {
        var security = this.get_user_security(user);
        security.login._pin_value = pin + "";
        return security;
    };
    TranService.prototype.get_user_security = function (user) {
    ...
    TranService.prototype.parse_user = function (user) {
        try {
    ...
    TranService.prototype.parse_if_string = function (str) {
        var temp = str;
...
exports.TranService = TranService;
