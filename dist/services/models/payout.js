...
var PayoutService = (function () {
    ...
    PayoutService.prototype.complete_payout = function (payout_id) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.get_payout(payout_id).then(function (res) {
                ...
                var apiSrv = new api_1.ApiService();
                apiSrv.post("payouts/complete/" + payout.id + "/" + payout.amount, {}).then(function (res) {
                    var payout = res.body.data;
                    resolve(payout);
    ...
    PayoutService.prototype.simulate_payout = function (create_payout_object) {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4, this.create_payout(create_payout_object).then(function (res) {
                                            result.success = true;
